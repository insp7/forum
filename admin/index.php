                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php $comments = new Comments(); echo mysqli_num_rows($comments->getAllComments()); ?></div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php $posts = new Posts(); echo mysqli_num_rows($posts->getAllPosts()); ?></div>
                                        <div>All Posts!</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php $users = new Users(); echo mysqli_num_rows($users->getAllUsers()); ?></div>
                                        <div>All Users!</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php $roles = new Roles(); echo mysqli_num_rows($roles->getAllRoles()); ?></div>
                                        <div>All Roles!</div>
                                    </div>
                                </div>
                            </div>
