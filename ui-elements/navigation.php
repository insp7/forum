                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li>
                            <!-- <form action="logout.php" method="POST">
                                ...
                                style="background: none; color: inherit; border: none; padding: 0; font: inherit; outline: inherit; padding-left: 22px">
                            ...
                            <?php
                                print_r($_SESSION);
                            ?>
                            <button style="background: none; color: inherit; border: none; padding: 0; font: inherit; outline: inherit; padding-left: 22px" onclick="logoutButtonClicked(event);">
                            <i class="fa fa-sign-out fa-fw"></i> Logout</button>
